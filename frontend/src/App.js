...
const GoogleSignInButton = ({ onSuccess, onError, text = "continue_with" }) => {
  ...
  // Keep callbacks current without re-triggering the init effect.
  ...
  if (isLoading) {
    return (
      <div className="w-full bg-white text-[#1f1f1f] flex items-center justify-center gap-3 border border-[#dadce0]" style={{ height: '40px', fontFamily: 'Roboto, "Helvetica Neue", Arial, sans-serif', fontWeight: 500, fontSize: 14 }}>
        ...
        <Panel>
          ...
          {trendData.length > 0 ? (
            <>
              ...
              <p className="text-meta text-ink-faint mt-2">
                Cohort-locked: only companies with 4+ months of history. MTD bar may be below "Active postings" above.
              </p>
            </>
          ) : (
